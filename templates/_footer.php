<footer>
    ...
    <div class="footer__top row">
        ...
        <div class="footer__list col-lg-2 col-md-4 col-sm-12 my-3 d-flex flex-column align-items-start justify-content-start">
            <h2>Quick Links</h2>
        ...
        <div class="footer__list col-lg-2 col-md-4 col-sm-12 my-3 d-flex flex-column align-items-start justify-content-start">
            ...
            <div style="width: 100%"><iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0"
                    marginwidth="0" style="border-radius: 10px;"
        ...
        <div class="footer__list col-lg-3 col-md-4 col-sm-12 my-3 d-flex flex-column align-items-start justify-content-start">
            <h2>Contact Us</h2>
