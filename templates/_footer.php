<footer>
    ...
    <div class="container ">
        ...
        <div class="footer__top row">
            ...
            <div
                class="footer__list col-lg-3 col-md-4 col-sm-12 d-flex flex-column align-items-start justify-content-between ">
                <a href="#">
            ...
            <div
                class="footer__list col-lg-2 col-md-4 col-sm-12 my-3 d-flex flex-column align-items-start justify-content-start">
                <h2>Quick Links</h2>
            ...
            <div
                class="footer__list col-lg-3 col-md-4 col-sm-12 my-3 d-flex flex-column align-items-start justify-content-start">
                <h2>Contact Us</h2>
