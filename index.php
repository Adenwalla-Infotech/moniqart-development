...
<body>
    ...
    <div class="banner-image w-100 d-flex justify-content-center align-items-center">
        <div class="content text-center">
            <h2 class="text-uppercase text-white fw-bold herotitle">
    ...
    <section class="container my-5 creativeSection">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12   d-flex flex-column align-items-start justify-content-evenly ">
                <h3 style="font-weight: bold;">Get Inspired</h3>
                <p style="color:#98989A;font-size:18px">
                    At MONIQART, we cover a full range of courses across all level of creativity and education. We aim to inspire you no matter where you are with our online presence. Take a look at what we offer.
                </p>
            ...
            <div
                ...
                <h5 style="font-weight: bold;">WORKSHOPS</h5>
                <span style="color:#98989A;font-size:16px">For artists and art enthusiasts to come together and learn new skills, techniques, and ideas.</span>
            </div>
            <div
                class="col-lg-3 col-md-6 col-12   d-flex flex-column align-items-center justify-content-between  border border-0 border-end  border-dark   ">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <h5 style="font-weight: bold;">Courses</h5>
                <span style="color:#98989A;font-size:16px">Explore your creative potential and develop in-depth skills through structured art sessions.</span>
            </div>
            <div class="col-lg-3 col-md-6 col-12   d-flex flex-column align-items-center justify-content-between ">
                ...
                <h5 style="font-weight: bold;">Art Therapy</h5>
                <span style="color:#98989A;font-size:16px">Enhance personal well-being, improve emotional and mental health through art.</span>
            </div>
        </div>
    </section>
