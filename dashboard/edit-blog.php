                                ...
                                <form method="POST" action="" enctype="multipart/form-data" class="needs-validation"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6" style="margin-bottom: 20px;">
                                            ...
                                            <input type="text" class="form-control" placeholder="Blog Title"
                                                aria-label="Blog Title" id="blogtitle" name="_blogtitle"
                                                value="<?php echo _getSingleBlog($_id, '_blogtitle') ?>" required>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6" style="margin-bottom: 20px;">
                                            ...
                                            <input style="margin-bottom: 5px;" class="form-control" name="file"
                                    ...
                                    <div class="row g-3">
                                        <div class="col">
                                            ...
                                            <textarea name="_blogdesc" id="mytextarea" minlength="20"
                                                required><?php echo _getSingleBlog($_id, '_blogdesc') ?></textarea>
                                            <div class="invalid-feedback">Blog Description Required (More than 20 Words)
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col" style="margin-top: 30px;">
                                            ...
                                            <textarea name="_blogmetadesc" style="line-height: 1.5em;" rows="3"
                                                class="form-control" minlength="5"
                                                required><?php echo _getSingleBlog($_id, '_blogmetadesc') ?></textarea>
                                            <div class="invalid-feedback">Blog Meta Description Required (More than 10
                                                Words) </div>
                                        </div>
                                    </div>
