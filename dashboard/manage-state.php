...
if (isset($_POST['submit'])) {
  ...
  $_statename = $_POST['stateName'];
  $_statecode = $_POST['stateCode'];
  ...
  _addStateMarkup($_statename, $_statecode, $_countryid, $status);
...
if (isset($_POST['updateState'])) {
  ...
  _updateStateMarkup($_stateid, $_statename, $_statecode, $_countryid, $status);
...
<body>
  <div class="container-scroller">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">State Markup</h4>
                    ...
                    <div class="table-responsive">
                      <table id="example" class="display table expandable-table" style="width:100%">
                        ...
                        <tbody style="text-align: left;margin-left: 30px">
                          ...
                          if (!isset($_POST['search'])) {
                            _getAllStateMarkup($start_from, $record_per_page);
                          }
                          ?>
                        </tbody>
                      </table>
                ...
                <nav aria-label="Page navigation example" style="margin-top: 30px;">
                  <ul class="pagination">
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM `tblstates`");
                    ...
                    if ($page > 1) {
                      echo "<li class='page-item'>
                        <a href='manage-state?page=" . ($page - 1) . "' class='page-link'>Previous</a>
                      </li>";
                    }
                    if ($total_records > 5) {
                      for ($i = 1; $i <= $total_pages; $i++) {
                        echo "
                      <li class='page-item'><a class='page-link' href='manage-state?page=" . $i . "'>$i</a></li>";
                      }
                    }
                    if ($page <= $end_loop) {
                      echo "<li class='page-item'>
                        <a class='page-link' href='manage-state?page=" . ($page + 1) . "'>Next</a>
                      </li>";
                    } ?>
                  </ul>
                </nav>
    ...
    <!-- Modal -->
    <div class="modal fade" id="editState" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" id="editStateBody">
    ...
    <script>
      ...
      const callEditStateMarkup = (id) => {


        $.ajax({
          type: "POST",
          url: `edit-statemarkup.php`,
          data: {
            "edit": true,
            "stateid": id,
          },
          success: function (data) {
            $(`#editStateBody`).html(data);
