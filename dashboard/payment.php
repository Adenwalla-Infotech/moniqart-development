    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-4">
                                                        <label class="small mb-1" for="inputEmailAddress">Username (Name
                                                            on the Invoice)</label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h5>Sub Total</h5> <input class="form-control" name="amount"
                                                            type="text" readonly
                                                            value="<?php echo $currency; ?>&nbsp;<?php echo round($getamount, 2); ?>">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <?php echo _gettaxes(); ?>
                                                    ...
                                                    <div class="col-lg-12" style="margin-top: 20px;">
                                                        <h5>Total Amount (To Pay)</h5> <input class="form-control"
                                                            name="amount" type="text" readonly
                                                            value="<?php echo $currency; ?>&nbsp;<?php echo round(_gettotal($getamount, $currency, $applydiscount), 2); ?>">
                                                        <?php if ($memebership) { ?>
                                                        <p style="margin-top: 5px;color:green"><svg fill="green"
                                                            ...
                                                            </svg>&nbsp;&nbsp;Membership Discount
                                                            <?php echo $currency; ?>&nbsp;<?php echo $memebership; ?>
                                                        </p>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="text" value="<?php echo $couponcode; ?>" readonly
                                                ...
                                                <div class="row" style="margin-left: 0px;">
                                                    ...
                                                    <div class="col-12" style="padding: 0px;">
                                                        <button name="pay" class="btn btn-primary"
                                                            style="margin-top: 30px;width:95%" type="submit"><svg
                                                                xmlns="http://www.w3.org/2000/svg" style="width: 15px;"
                                                                fill="white"
                                                                viewBox="0 0 512 512"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) -->
                                                                <path
               ...
               1){ ??
                                                    <div class="col-12" style="padding: 0px">
                                                        <button name="payment" class="btn btn-success"
                                                            style="margin-top: 30px;width:95%" type="button"
                                                            id="rzp-button2">Pay&nbsp;&nbsp;<?php echo $currency; ?>&nbsp;<?php echo round(_gettotal($getamount, $currency, $applydiscount), 2); ?></button>
                                                    </div>
                                                    <?php } else { ?>
                                                    <div class="col-12" style="padding: 0px">
                                                        <button name="pay" id="rzp-button1" class="btn btn-success"
                                                            style="margin-top: 30px;width:95%"
                                                            type="button">Pay&nbsp;&nbsp;<?php echo $currency; ?>&nbsp;<?php echo round(_gettotal($getamount, $currency, $applydiscount), 2); ?></button>
                                                    </div>
                                                    <?php } ?>
                                                    <?php } ?>
                                                </div>
