...
if (isset($_POST['submit'])) {
    ...
    $pageName = '_aboutuspage';
    $pageData = $_POST['aboutpageinfo'];
...
if (isset($_POST['editFaq'])) {
    ...
    _updateFaq($faqid, $question, $answer);
...
<head>
    ...
    <title>Page Setting - About Us | <?php echo _siteconfig('_sitetitle'); ?></title>
    <!-- plugins:css -->
...
<body>
    <div class="container-scroller">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Write Info for <span>About us</span> Page </h4>
                                ...
                                <form method="POST" action="" enctype="multipart/form-data" class="needs-validation"
                                    ...
                                    <div class="row g-3">
                                        <div class="col">
                                            <textarea name="aboutpageinfo" rows="20"
                                                class="form-control"><?php echo _getPageInformation('_aboutuspage'); ?></textarea>
                            ...
                            <div class="card-body" style="margin-top: 30px ;">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="display expandable-table" style="width:100%">
                                                ...
                                                <tbody style="text-align: left;margin-left: 30px">
                                                    <?php
                                                    _getFaqs($start_from, $record_per_page);
                                                    ?>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <nav aria-label="Page navigation example" style="margin-top: 10px;">
                                    <ul class="pagination">
                                        <?php
                                        $query = mysqli_query($conn, "SELECT * FROM `tblfaqs`");
                        ...
                        <a href='pageSetting-about&page=" . ($page - 1) . "' class='page-link'>Previous</a>
                      </li>";
                                        }
                                        if ($total_records > 5) {
                                            ...
                                            for ($i = 1; $i <= $total_pages; $i++) {
                                                echo "
                      <li class='page-item'><a class='page-link' href='pageSetting-about&page=" . $i . "'>$i</a></li>";
                                            }
                                        }
                                        if ($page <= $end_loop) {
                                            echo "<li class='page-item'>
                        <a class='page-link' href='pageSetting-about&page=" . ($page + 1) . "'>Next</a>
                      </li>";
                                        } ?>
                                    </ul>
                                </nav>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="modal-content" style="padding: 10px;">
                        <div class="modal-header" style="padding: 0px;margin-bottom: 20px;padding-bottom:10px">
                            <h4 class="modal-title fs-5" id="exampleModalLabel">Add Faq</h4>
        ...
        <div class="modal fade" id="editFaq" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" id="editFaqBody">
