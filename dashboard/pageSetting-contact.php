...
if (isset($_POST['submit'])) {
    ...
    $pageName = '_contactuspage';
    $pageData = $_POST['contactpageinfo'];
...
<head>
    ...
    <title>Page Setting - Contact Us | <?php echo _siteconfig('_sitetitle'); ?></title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Write Info for <span>Contact us</span> Page </h4>
                                ...
                                <form method="POST" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    ...
                                    <div class="row g-3">
                                        <div class="col">
                                            <textarea name="contactpageinfo" rows="20" class="form-control"><?php echo _getPageInformation('_contactuspage');  ?></textarea>
