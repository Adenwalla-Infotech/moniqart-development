    ...
    <section class="contact" id="contact" >
        <div class="contactform__container container">
            ...
            <div class="contactform-left">
                ...
                <h3 class="contactform__heading">GET IN <span>TOUCH!</span></h3>
                ...
                <form action="" class="contact__form-form">
                    ...
                    <textarea name="" id="" rows="4">Comment</textarea>
                    <button>
                        Submit
                    </button>
                </form>
            ...
            <div class="contactform-right">
                ...
                <div class="contactform-card">
                    <h1 class="contact__card-heading">
                        MAIN OFFICE
                    </h1>
                    <p class="contact__card-link"> <i class="bx bx-current-location"></i> Rokin 94, 1012 Amsterdam </p>
                    <p class="contact__card-link"> <i class="bx bx-phone-incoming"></i> Phone: +88 (0) 101 0000 000 </p>
                    <p class="contact__card-link"> <i class="bx bx-file"></i>  Fax: +88 (0) 202 0000 001 </p>
                    <p class="contact__card-link"> <i class="bx bx-envelope"></i> Email: youremail@yourdomain.com </p>
                </div>
